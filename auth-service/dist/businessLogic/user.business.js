...
var genKey = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    var key, payload;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                key = process.env.TOKEN_KEY || crypto_1.default.randomBytes(16).toString("hex");
                payload = {
                    _id: user._id,
                    userName: user.userName
                };
                return [4 /*yield*/, jsonwebtoken_1.default.sign(payload, key)];
            ...
            case 1:
                ...
                if (!result) {
                    error = {
                        ...
                        message: user_enum_1.LoginErrorMessage.USERNAME_NOT_FOUND
                    };
                    throw error;
                }
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (result) {
                    error = {
                        status: http_status_codes_1.CONFLICT,
                        message: user_enum_1.SignUpErrorMessage
                    };
                    throw error;
                }
